...
* [atosmed somnofox](https://atmosmed.com/de/produkte-loesungen/hno/diagnostik-therapie/schlafdiagnostik/somnofox)
* [snorefox.com](https://snorefox.com/)

## Soziale Medien

[PneumoPearls](https://pneumopearls.de/) ist ein digitaler Social-Media-Info-Hub, der pneumologisches Fachwissen verständlich und praxisnah vermittelt. Es werden aktuelle Erkenntnisse, Therapien und Tipps in kompakten Erklärvideos, Infografiken und fundierten Beiträgen geteilt. Die Plattform richtet sich an Fach- und Hausärzt:innen, Patient:innen, Angehörige und alle Interessierten, bietet fachliche Tiefe und fördert den Austausch über Themen rund um Atmung, Lunge und moderne Pneumologie.
...
* [alpha1-deutschland.org](https://alpha1-deutschland.org/)
...
„Forecasting the Impacts of Artificial Intelligence Assistance in Virtual Consultations for Chronic Obstructive Pulmonary Disease: Exploratory Futures Wheel Study“ untersucht die möglichen Auswirkungen eines speziell entwickelten KI-Assistenzsystems für virtuelle Konsultationen bei chronisch obstruktiver Lungenerkrankung (COPD). Mithilfe der Futures-Wheel-Methode analysierten Patienten und Gesundheitsfachkräfte potenzielle Folgen in acht Bereichen, darunter Arzt-Patienten-Beziehung, Psychologie, Ethik, Recht, Technologie und Gesundheitsversorgung. Die Teilnehmenden erwarteten überwiegend positive Effekte wie stärkere Patienteneinbindung, verbesserte Kommunikation, effizientere Abläufe, bessere Schulungs- und Unterstützungsfunktionen sowie eine patientenzentriertere Versorgung. Gleichzeitig wurden Risiken und Voraussetzungen identifiziert, darunter regulatorische Anforderungen, ethische Aspekte, ausreichende Ressourcen und die Notwendigkeit einer verantwortungsvollen Nutzung. Die Studie kommt zu dem Schluss, dass KI die virtuelle COPD-Versorgung sinnvoll unterstützen kann, jedoch eine sorgfältige Planung, Governance und Implementierung erforderlich sind.
...
„Elevated COPD patient engagement and timely care prioritisation facilitated by use of text message accuRx Florey questionnaire in routine primary care“ beschreibt den Einsatz eines textbasierten digitalen Fragebogens zur verbesserten Versorgung von COPD-Patienten in der Primärversorgung. Die Ergebnisse zeigen, dass durch die Integration des accuRx-Florey-Systems eine strukturierte Datenerhebung, bessere Patientenpriorisierung und eine gesteigerte Engagement-Rate (61 % Response) erreicht werden kann. Insgesamt deutet die Anwendung auf ein effizienteres, digital unterstütztes Versorgungsmodell im Praxisalltag hin.

„RESPClinBench: Benchmarking Multimodal Clinical Decision-Making and Longitudinal Disease Management in Respiratory Specialty Care“ untersucht sieben aktuelle Sprachmodelle anhand von 623 realitätsnahen respiratorischen Fällen zu COPD-Management und pulmonalen Rundherden. Die Ergebnisse zeigen moderate Gesamtleistungen, deutliche Lücken bei der expliziten Abdeckung klinischer Maßnahmen sowie relevante Sicherheitsprobleme: Bei der multimodalen Beurteilung traten Bildhalluzinationen in 31,85 % und schwerwiegende medizinische Risiken in 8,16 % der Antworten auf.

Die systematische Übersichtsarbeit **„Risk prediction for lung cancer screening: a systematic review and meta-regression“** bewertet die seit 2020 entwickelten Risikomodelle für das Lungenkrebsscreening. Insgesamt wurden 91 Modelle identifiziert, die entweder die Auswahl geeigneter Personen für ein Low-Dose-CT-Screening oder die Risikobewertung von nach dem Screening entdeckten Lungenknoten unterstützen. Während biomarker- und bildgebungsbasierte Modelle häufig eine höhere Vorhersagegenauigkeit erreichten als klassische Regressionsmodelle, fehlten bei vielen Modellen externe Validierungen und belastbare Daten zur klinischen Anwendbarkeit. Die Autoren empfehlen daher, bestehende Modelle zu validieren und prospektiv zu evaluieren, anstatt weitere neue Modelle zu entwickeln.

„Quantum Kernel Estimation for the Discovery of Early Lung Cancer Detection“ untersucht quantenklassische Machine-Learning-Verfahren zur Erkennung von Lungenkrebs anhand zellfreier DNA. Quantenkernel-Modelle waren insbesondere bei Fragmentomics-Daten konkurrenzfähig gegenüber klassischen SVM-Modellen, während 20 ausgewählte Merkmale insgesamt stabilere Ergebnisse als 40 Merkmale lieferten. Bei den Methylierungsdaten blieb die klassische SVM am leistungsfähigsten.

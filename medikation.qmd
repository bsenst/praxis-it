...
* [kbv.de/.../medikationsplan-anlage-3.pdf](https://www.kbv.de/documents/infothek/rechtsquellen/weitere-vertraege/praxen/medikationsplan/medikationsplan-anlage-3.pdf)
* [hl7.de/ukf/Testfaelle_ukf201.pdf](https://download.hl7.de/ukf/Testfaelle_ukf201.pdf)
* [aspose.app/barcode/de/recognize/datamatrix](https://products.aspose.app/barcode/de/recognize/datamatrix)
...
[pharma4u](https://www.pharma4u.de) bietet digitale Lösungen für Studium und Apothekenpraxis mit Fokus auf Dokumentation, Eigenrevision und Medikationsmanagement. Mit der Software ApoRevision wird die digitale Eigenrevision samt Pflichtschulungen unterstützt, während LabXpert rechtskonforme Dokumentation in Rezeptur und Labor ermöglicht. MediCheck fördert die digitale Umsetzung von Medikationsanalysen für mehr Arzneimitteltherapiesicherheit. Ergänzt wird das Angebot durch interaktive Lernprogramme, Webseminare und Kompetenz-Foren, die den digitalen Wissenstransfer in der Pharmazie stärken.

## Weiteres

Die Studie „Patients’ perceptions, experiences, and satisfaction with e-prescribing system: A cross-sectional study“ wurde 2024 im International Journal of Medical Informatics veröffentlicht. Sie untersuchte an 384 Patienten in fünf Lehrkrankenhäusern in Zahedan, Iran, die Wahrnehmung, Erfahrungen und Zufriedenheit mit dem seit Dezember 2021 verpflichtenden elektronischen Verschreibungssystem. Rund 85 % der Befragten kannten das System, 70 % bevorzugten es gegenüber Papierverordnungen. Die Zufriedenheit lag bei 3,91 von 5 Punkten, die Einstellung bei 3,45 und der wahrgenommene Einfluss auf die Patientenversorgung bei 3,10. Es bestand eine signifikante Korrelation zwischen Einstellung und Versorgungseinfluss.
...
„A Comprehensive Self-Medication Management System to Reduce Medication Errors Among People Living With Dementia: Mixed Methods Feasibility and Usability Study“ untersucht ein KI-gestütztes Selbstmedikationssystem für Menschen mit Demenz und deren Betreuungspersonen. Die Studie evaluiert die Machbarkeit, Benutzerfreundlichkeit und technische Zuverlässigkeit eines automatisierten Medikationssystems im häuslichen Umfeld in einer Mixed-Methods-Erhebung mit Dyaden. Die Ergebnisse zeigen eine insgesamt überdurchschnittliche Usability (SUS ~70) sowie Hinweise auf verbesserte Adhärenzüberwachung und potenzielle Entlastung von Pflegepersonen.

Die Studie „Appropriateness of ChatGPT as a resource for medication-related questions“ untersucht, wie zuverlässig ChatGPT bei der Beantwortung arzneimittelbezogener Fachfragen ist. Anhand realer Anfragen an einen universitären Arzneimittelinformationsdienst zeigt sich, dass GPT-3.5 nur einen kleinen Teil der Fragen vollständig und korrekt beantworten konnte. Die Ergebnisse unterstreichen, dass generative KI im Bereich der Arzneimittelinformation derzeit nur mit großer Vorsicht eingesetzt werden sollte und professionelle Fachquellen nicht ersetzen kann.

Individual Pharmacotherapy Management (IPM-II) for Patient and Drug Safety in Polypharmacy via Clinical Electronic Health Record Is Associated with Significant Fall Prevention beschreibt eine retrospektive Interventionsstudie im geriatrischen Setting. Analysiert wurde der Effekt EHR-basierter Medikationsanpassungen auf Sturzereignisse bei älteren Patient:innen mit Polypharmazie. Die Ergebnisse zeigen eine signifikante Reduktion in-hospitaler Stürze nach Implementierung des IPM-II-Ansatzes sowie Hinweise auf relevante Medikationsrisiken als zentrale iatrogene Ursache von Stürzen. Die Studie unterstützt den Einsatz digital gestützter, individualisierter Pharmakotherapie-Managementsysteme zur Verbesserung der Arzneimittel- und Patientensicherheit in der Geriatrie.

Der Text „Role of Artificial Intelligence in Patient Safety Outcomes: Systematic Literature Review“ analysiert 53 Studien zum Einsatz von KI in der klinischen Patientensicherheit. Die Ergebnisse zeigen vor allem Anwendungen in den Bereichen Medikationssicherheit, klinische Reports und Alarmmanagement. Insgesamt berichten die Studien überwiegend positive Effekte, weisen jedoch erhebliche Heterogenität in Methoden und Bewertungsmetriken sowie einen Mangel an standardisierten Benchmarks auf.

„Clinical decision support systems to improve drug prescription and therapy optimisation in clinical practice: a scoping review“ untersucht die Eigenschaften klinischer Entscheidungsunterstützungssysteme (CDSS) und deren Einfluss auf die Verbesserung der Arzneimittelverordnung und Therapieoptimierung in der klinischen Praxis. Die Scoping Review analysiert 42 Studien aus verschiedenen medizinischen Settings und zeigt, dass insbesondere regelbasierte, in elektronische Gesundheitssysteme integrierte CDSS in Kombination mit interprofessionellen Teams häufig mit positiven klinischen Ergebnissen verbunden sind. Zudem werden zentrale Erfolgsfaktoren wie Studiendesign, Patientenkomplexität und die Einbindung von Apothekern herausgearbeitet.

„Clinical decision support systems-based interventions to improve medication outcomes: A systematic literature review on features and effects“ untersucht systematisch den Einfluss klinischer Entscheidungssupportsysteme (CDSS) auf medikationsbezogene Versorgungsprozesse und Patientensicherheit. Die Analyse von 98 eingeschlossenen Studien zeigt überwiegend positive Effekte auf Verschreibungsqualität, Reduktion von Medikationsfehlern sowie Arzneimittelinteraktionen. Gleichzeitig wird deutlich, dass vor allem Prozessindikatoren verbessert werden, während robuste Evidenz zu patientenbezogenen Outcomes und Implementierungsfaktoren weiterhin begrenzt ist.

„A pharmacist-led information technology intervention for medication errors (PINCER): a multicentre, cluster randomised, controlled trial and cost-effectiveness analysis“ untersucht die Wirksamkeit einer IT-gestützten, pharmazeutisch geleiteten Intervention zur Reduktion von Medikationsfehlern in der hausärztlichen Versorgung. Die Studie zeigt, dass die PINCER-Intervention im Vergleich zu einfachem Feedback signifikant häufiger riskante Verordnungen und unzureichendes Monitoring reduziert und dabei sowohl klinisch relevante Verbesserungen als auch eine hohe Kosteneffektivität erreicht.

Die EMAIL-HF-Studie untersuchte eine registry-basierte digitale Strategie zur Verbesserung der leitliniengerechten Behandlung von Patienten mit Herzinsuffizienz. Durch die gezielte Identifikation unbehandelter Patienten und die Einladung zu einer telefonischen fachärztlichen Beratung konnte die Initiierung einer SGLT2-Inhibitor-Therapie innerhalb von sechs Monaten mehr als verdoppelt werden (18,6 % vs. 8,2 %). Ein signifikanter Unterschied bei Hospitalisierung wegen Herzinsuffizienz oder Gesamtmortalität wurde nicht festgestellt. Die Ergebnisse zeigen das Potenzial digitaler Versorgungssysteme, die Umsetzung evidenzbasierter Therapien zu verbessern.

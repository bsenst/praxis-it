...
|-------------------------------|--------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------|
| Dieter macht den Datenschutz  | Ein Tool, das Datenschutz einfach und verständlich macht.                                                    | [dietermachtdatenschutz.de](https://www.dieter-datenschutz.de/)                                  |
...
Das Open-Source-Projekt Privacy Guardrail ist eine lokale Browser-Erweiterung des German Research Center for Artificial Intelligence zur Erkennung und Anonymisierung personenbezogener Daten vor dem Einfügen in KI-Chatoberflächen wie ChatGPT, Claude und Gemini. Die Erweiterung nutzt Rust/WASM-basierte Mustererkennung sowie optional lokale Transformer-NER-Modelle via ONNX Runtime Web und verarbeitet alle Inhalte ausschließlich lokal im Browser ohne Telemetrie oder externe Datenübertragung. Unterstützt werden unter anderem E-Mail-Adressen, Telefonnummern, Kreditkarten, IBANs, IP-Adressen sowie frei formulierte personenbezogene Informationen. Das Projekt befindet sich aktuell in einer öffentlichen Beta-Version und adressiert Datenschutzrisiken bei der Nutzung generativer KI-Systeme durch lokale Vorverarbeitung sensibler Inhalte.

„When the Chatbot Leaks: Securing Patient-Facing Medical AI in the Age of Dual-Use Large Language Models“ zeigt, dass Retrieval-Augmented Generation (RAG) keine Sicherheitsgrenze darstellt. Bei einem öffentlich zugänglichen medizinischen Chatbot konnten ohne Authentifizierung unter anderem System-Prompt, Pipeline-Konfiguration, Wissensbasis und 1.000 gespeicherte Patientengespräche abgerufen werden. Die Autoren betonen daher, dass medizinische KI nicht nur als Modell, sondern als vollständig abgesichertes Softwaresystem evaluiert werden muss.

...
* [secunet.com](https://www.secunet.com/loesungen/sina-l3-box)
* [watchguard.com](https://www.watchguard.com/wgrd-products/firewalls)
* [securepoint.de](https://www.securepoint.de/fuer-unternehmen/utm-firewall/black-dwarf-serie/g5/black-dwarf)
* [pfsense.org](https://www.pfsense.org/)
* [bitdefender.com](https://www.bitdefender.com/de-de/)
* [bitwarden.eu](https://bitwarden.eu/)
...
{{< video https://www.youtube.com/watch?v=aOGFY1R4QQ4 >}}
...
* [cyfun.eu/de](https://cyfun.eu/de)

**DsiN-Sicherheitsindex 2025** analysiert die digitale Sicherheitslage von Verbraucher:innen in Deutschland mit dem Schwerpunkt „Vertrauen in der digitalen Welt“. Die Studie zeigt, dass die Sicherheitslage trotz eines hohen Sicherheitswissens auf einem historischen Tiefstand stagniert, da Sicherheitsvorfälle weiter zunehmen und das Sicherheitsverhalten mit der Bedrohungslage nicht Schritt hält. Besonders hervorgehoben werden die wachsende Lücke zwischen Wissen und Handeln sowie die Bedeutung von Vertrauen, digitaler Kompetenz und zielgerichteter Aufklärung für eine resilientere digitale Gesellschaft.

„Lost in Translation: Intrusion Detection Research with “Kaggle Datasets” untersucht die Datenprovenienz von 13 auf Kaggle archivierten Datensätzen, die in 15 peer-reviewten Publikationen zur Intrusion Detection verwendet wurden. Die Analyse zeigt erhebliche Defizite bei Urheberschaft, Herkunft, Aufbereitung und Operationalisierung der Daten; insbesondere fehlen Angaben zu Preprocessing und Feature-Definitionen weitgehend. Dadurch können veränderte oder unklar dokumentierte Datensatzversionen die Reproduzierbarkeit und Vergleichbarkeit der Forschung beeinträchtigen. Als Gegenmaßnahmen werden bessere Metadaten, peer-reviewte Begleitpublikationen, kryptografische Hashes und geprüfte Benchmark-Datensätze vorgeschlagen.

„Mapping Machine Learning–Driven Cybersecurity Solutions in Health Care: Scoping Literature Review“ untersucht den Einsatz von Machine Learning zur Cybersicherheit im Gesundheitswesen und ordnet die vorhandene Evidenz entlang der sechs Funktionen des NIST Cybersecurity Framework 2.0 ein. Die Scoping-Review umfasst 45 Studien aus 18 Ländern und 80 ML-Modelle; besonders stark vertreten sind Schutzmaßnahmen und Angriffserkennung. Für Reaktion, Wiederherstellung und Governance bestehen dagegen deutliche Forschungslücken, während die praktische Validierung bislang nur in Einzelfällen erfolgte.
